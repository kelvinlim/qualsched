...
pub struct DistributionRow {
    ...
    /// The recipient's phone and email, carried so the table can be searched by them.
    /// Empty when the recipient could not be resolved; filled in by the command layer.
